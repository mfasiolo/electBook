#'
#' Internal functions for smoothing 
#' 
#' @description These are not supposed to be used by others.
#'
#' @param x,num.knots internal arguments
...
#variance smoother
#' @param lambda2,eta,W2,R,tol,maxiter internal arguments
#' @rdname internals
#' @export 
#'
...
#EM algorithm
#' @param beta.hat,sigma,lambda1,lambda3,lambdanu,D,tol,maxiter internal arguments
#' @rdname internals
#' @export 
#'
...
#' @param lambda,lambda3,lambdanu,sigma,beta,maxiter internal arguments
#' @rdname internals
#' @export 
#'
...
#' @param nlambda,lambda1,lambdanu,sigma,beta internal arguments
#' @rdname internals
#' @export 
#'
...
#' @param nlambda,sigma,lambda1 internal arguments
#' @rdname internals
#' @export 
#'
